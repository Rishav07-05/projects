    ...
    <div className="w-full p-20 bg-[#CDEA68] text-black rounded-tl-3xl rounded-tr-3xl">
      ...
      <div className="flex gap-20">
        <div className="w-1/2">
          ...
          <button className="flex gap-6 items-center px-7 py-4 bg-zinc-900 rounded-full text-white">
            Read More
            <div className="w-3 h-3 bg-zinc-100 rounded-full"></div>
          </button>
        </div>
        <div className="w-1/3 h-[60vh] rounded-3xl bg-[#b6c778]">
          <img className="w-full h-full bg-cover rounded-3xl " src="https://w.wallhaven.cc/full/5g/wallhaven-5g9ed8.png" alt="just image" />
        </div>
      </div>
    </div>
  );
