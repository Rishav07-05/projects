  ...
  return (
    <div className="h-screen w-full text-white flex items-center justify-center ">
      <div className="w-[30%] h-[50%] bg-transparent p-8 border-[1px] rounded-4xl border-t-green-400 border-l-green-400 border-b-blue-400 border-r-blue-400 shadow-[0_0_10px_10px_rgba(155,77,255,0.7),0_0_10px_10px_rgba(0,0,255,0.7)] transition-all">
        <h1
          className="text-4xl text-center m-8 font-bold text-emerald-600"
          style={{
            WebkitTextStroke: ".9px lightblue",
      ...
      <div className="relative ">
        <button className="absolute top-[138px] right-6   bg-transparent border-[3px] align-center font-semibold rounded-full px-9 py-3 mb-5 border-green-500 hover:border-green-500 hover:shadow-[0_0_10px_5px_rgba(0,255,0,0.7)]">
