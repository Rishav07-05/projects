...
const defaultItems: MenuItem[] = [
  {
    _id: "default-id", // ✅ Add a dummy _id
    image: "https://picsum.photos/900/900?grayscale",
    link: "https://google.com/",
    title: "Sample Post",
    description: "This is a default placeholder.",
  },
];
...
const InfiniteMenu: FC<InfiniteMenuProps> = ({ items = [] , onDelete }) => {
 ...
 return (
   <div className="relative w-full h-full bg-black overflow-hidden">
     ...
     {activeItem && (
       <>
         <h2 className="text-[#ff7300] select-none absolute font-black md:text-[1rem] text-[0.6rem] left-[1.6em] top-1/2 transform translate-x-[20%] -translate-y-1/2 transition-all ease-[cubic-bezier(0.25,0.1,0.25,1.0)]">
           {activeItem.title}
         </h2>

         <div className="text-[#cfbfa0] select-none absolute mt-10 max-w-[10ch] text-[1rem] md:text-[2rem] top-1/2 right-[1%] transition-all ease-[cubic-bezier(0.25,0.1,0.25,1.0)]">
           {activeItem.description}
           <div
             onClick={() => onDelete?.(activeItem._id as string)}
             className="absolute text-end left-1/2 z-10 w-[120px] h-[40px] mt-10  -translate-x-1/2 grid place-items-center bg-[#ff0000] rounded-xl cursor-pointer transition-all ease-[cubic-bezier(0.25,0.1,0.25,1.0)] hover:scale-110"
           >
