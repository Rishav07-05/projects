...
const Main = () => {
  ...
  return (
    <div className="h-screen w-full">
      ...
      {/* Profile Section */}
      <div className={`fixed top-0 right-0 h-full bg-zinc-700 w-[400px] z-200 transition-transform ${isProfileOpen ? "translate-x-0" : "translate-x-full"}`}>
        ...
        <div className="flex flex-col items-center mt-20 space-y-4">
          <h1 className="text-center mt-20 text-2xl font-semibold">
            <button className="px-9 py-3 rounded-full bg-green-500 border-green-400 font-bold text-zinc-900 text-xl hover:border-green-500 hover:shadow-[0_0_10px_5px_rgba(0,255,0,0.7)] transform transition-all hover:scale-110">My Post</button>
          </h1>
          <h1 className="text-center mt-4 text-2xl font-semibold">
            <button className="px-9 py-3 rounded-full bg-green-500 border-green-400 font-bold text-zinc-900 text-xl hover:border-green-500 hover:shadow-[0_0_10px_5px_rgba(0,255,0,0.7)] transform transition-all hover:scale-110" onClick={handleLogout}>Logout</button>
          </h1>
          <h1 className="text-center mt-4 text-2xl font-semibold">
