  ...
  return (
    <div className={cn("sticky top-80", className)}>
      ...
      <p className="text-xs md:text-xl font-normal font-bebas leading-loose tracking-wider text-center text-neutral-400 mt-4 max-w-lg mx-auto">
        {description ||
          `Code smarter, not harder — Refact AI rewrites, optimizes, and accelerates your development with lightning-fast AI precision.`}
      </p>
      <div className="w-full h-[890px] -top-60 md:-top-40  flex items-center justify-center bg-red-transparent absolute ">
        <Link to="/docs">
          <button className="relative font-bold text-xs md:text-base text-white bg-gradient-to-r cursor-pointer from-purple-500 via-pink-500 to-red-500 rounded-full px-4 py-2 md:px-6 md:py-3 mt-8 md:mt-24 mx-auto w-fit z-30 shadow-lg transition duration-300 hover:shadow-pink-500/50 hover:scale-105 ring-1 ring-white/10">
            <span className="relative z-10 ">refact.ai.dev</span>
            <span className="absolute inset-0 rounded-full bg-white opacity-10 blur-md animate-pulse"></span>
          </button>
        </Link>
      </div>
      <svg
      ...
      >
        ...
        <defs>
          ...
          <linearGradient id="gradient1" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#FF69A0" />
            <stop offset="100%" stopColor="#FF1472" />
          </linearGradient>
          ...
          <linearGradient id="gradient3" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#B0C7FF" />
            <stop offset="100%" stopColor="#4A65FF" />
          </linearGradient>
